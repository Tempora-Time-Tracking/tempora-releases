...
**[⬇ Download Tempora 1.0 (.dmg)](https://raw.githubusercontent.com/Tempora-Time-Tracking/tempora-releases/main/1.0/Tempora-1.0.dmg)**

Requires **macOS 15 (Sequoia) or later**. The app is signed with a Developer ID and notarized by Apple.

## Install

1. Open the downloaded `Tempora-1.0.dmg`.
