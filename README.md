...
**[⬇ Download Tempora 0.3 (.dmg)](https://raw.githubusercontent.com/Tempora-Time-Tracking/tempora-releases/main/0.3/Tempora-0.3.dmg)**

Requires **macOS 15 (Sequoia) or later**. The app is signed with a Developer ID and notarized by Apple.

## Install

1. Open the downloaded `Tempora-0.3.dmg`.
